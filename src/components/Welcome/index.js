  ...
  return (
    ...
    >
      ...
      <UnorderedList spacing={2}>
        ...
        <ListItem>
          Stock prices automatically change to reflect a team's win/loss record
          (.500 record means the stock is worth $500)
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          The money is, and I can't emphasize this enough, just pretend
        </ListItem>
      </UnorderedList>
    </PlainBox>
  );
